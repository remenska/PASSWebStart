...
public class DisciplinedEnglishPage  extends WizardPage  {
	...
	public void fillBehavior(){
		...
		behavior.put("Universality", "The event of interest for the required behavior is " + "["+ eventA + "]" + ". " + "["+ eventA + "]" + " must always carry the same parameter values. This is useful for checking if an object state always has a certain value. \nThe events in such case are often getter methods, querying the state value. ");
		behavior.put("AlwaysEnabled", "The event of interest for the required behavior is " + "["+ eventA + "]" + ". " + "["+ eventA + "]" + " must always be enabled/possible to occur, at every step of the execution. ");
	}
